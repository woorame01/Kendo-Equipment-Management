...
public class KKC_Equipment {
	...
	public KKC_Equipment(String number, String type, String gender, String date) {
		this.number = number;
		this.type = type;
		this.gender = gender;
		this.date = date;
	...
	public KKC_Equipment(String number, String type, String gender, String date, KKC_Member user) {
		this.number = number;
		this.type = type;
		this.gender = gender;
		this.date = date;
